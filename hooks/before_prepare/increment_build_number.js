...
fs.readFile('config.xml', 'utf8', function(err, data) {
  ...
  xml2js.parseString(xml, function (err, result) {
    ...
    var currentVer = parseInt(obj['widget']['$']['version'].split(".").join(""));
    var nextVer = ++currentVer;
    obj['widget']['$']['version'] = nextVer.toString().split("").join(".");
    ...
    fs.writeFile('config.xml', xml, function(err) {
      ...
      console.log('Build number successfully incremented to '+obj['widget']['$']['version']);
    });
